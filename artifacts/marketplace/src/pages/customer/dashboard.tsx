...
export default function CustomerDashboard() {
  ...
  if (isLoading) {
    return <Layout><div className="container py-12 text-muted-foreground">{t("customer_dashboard.loading")}</div></Layout>;
  }
        ...
        <div className="bg-card border rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="divide-y">
            {!dashboard?.recentOrders || dashboard.recentOrders.length === 0 ? (
              <div className="px-6 py-10 text-center text-muted-foreground">{t("customer_dashboard.no_orders")}</div>
            ) : (
