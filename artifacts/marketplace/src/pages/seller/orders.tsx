    ...
    <Layout>
      <div className="container py-8 md:py-12 max-w-6xl">
        ...
        <div className="bg-card border rounded-xl overflow-hidden shadow-sm">
          {isLoading ? (
            <div className="p-10 text-center text-muted-foreground">{t("seller_orders.loading")}</div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="min-w-[110px]">{t("seller_orders.date")}</TableHead>
                    <TableHead className="min-w-[160px]">{t("seller_orders.customer")}</TableHead>
                    <TableHead>{t("seller_orders.items")}</TableHead>
                    <TableHead className="text-right">{t("seller_orders.total")}</TableHead>
                    <TableHead className="w-[190px]">{t("seller_orders.status")}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {orders.map((order) => (
